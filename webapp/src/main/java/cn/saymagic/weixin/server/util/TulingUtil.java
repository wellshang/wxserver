...
public class TulingUtil {
	...
	public static String getResponse(String request, String userid)
			throws IOException {
		...
		String getURL = "http://www.tuling123.com/openapi/api?key="
				+ Config.APIKEY + "&info=" + INFO + "&userid=" + USER_ID;
	...
	public static String getContentStr(String request, String userid)
			throws IOException {
		Gson gson = new Gson();
		TulingResult result = gson.fromJson(getResponse(request, userid),
				TulingResult.class);
